...
open class FitLinearLayout @JvmOverloads constructor(
    ...
    init {
        ...
        if(ta != null){
            fitLeft = ta.getBoolean(R.styleable.FitLinearLayout_fitLeft, false)
            fitRight = ta.getBoolean(R.styleable.FitLinearLayout_fitRight, false)
            fitTop = ta.getBoolean(R.styleable.FitLinearLayout_fitTop, false)
            fitBottom = ta.getBoolean(R.styleable.FitLinearLayout_fitBottom, false)
            mPaddingTop = ta.getDimensionPixelSize(R.styleable.FitLinearLayout_paddingTop,0)
            mPaddingBottom = ta.getDimensionPixelSize(R.styleable.FitLinearLayout_paddingBottom,0)
            mPaddingLeft = ta.getDimensionPixelSize(R.styleable.FitLinearLayout_paddingLeft,0)
            mPaddingRight = ta.getDimensionPixelSize(R.styleable.FitLinearLayout_paddingRight,0)
            val mPaddingStart = ta.getDimensionPixelSize(R.styleable.FitLinearLayout_paddingStart,0)
            val mPaddingEnd = ta.getDimensionPixelSize(R.styleable.FitLinearLayout_paddingEnd,0)
            ...
            val mPaddingHorizontal = ta.getDimensionPixelSize(R.styleable.FitLinearLayout_paddingHorizontal,0)
            if (mPaddingHorizontal > 0){
                mPaddingLeft = mPaddingHorizontal
                mPaddingRight = mPaddingHorizontal
            }
            val mPaddingVertical = ta.getDimensionPixelSize(R.styleable.FitLinearLayout_paddingVertical,0)
            if (mPaddingVertical > 0){
                mPaddingTop = mPaddingVertical
                mPaddingBottom = mPaddingVertical
            }
            val mPadding = ta.getDimensionPixelSize(R.styleable.FitLinearLayout_padding,0)
            if (mPadding > 0){
