...
open class FitMotionLayout @JvmOverloads constructor(
    ...
    init {
        ...
        if(ta != null){
            fitLeft = ta.getBoolean(R.styleable.FitMotionLayout_fitLeft, false)
            fitRight = ta.getBoolean(R.styleable.FitMotionLayout_fitRight, false)
            fitTop = ta.getBoolean(R.styleable.FitMotionLayout_fitTop, false)
            fitBottom = ta.getBoolean(R.styleable.FitMotionLayout_fitBottom, false)
            mPaddingTop = ta.getDimensionPixelSize(R.styleable.FitMotionLayout_paddingTop,0)
            mPaddingBottom = ta.getDimensionPixelSize(R.styleable.FitMotionLayout_paddingBottom,0)
            mPaddingLeft = ta.getDimensionPixelSize(R.styleable.FitMotionLayout_paddingLeft,0)
            mPaddingRight = ta.getDimensionPixelSize(R.styleable.FitMotionLayout_paddingRight,0)
            val mPaddingStart = ta.getDimensionPixelSize(R.styleable.FitMotionLayout_paddingStart,0)
            val mPaddingEnd = ta.getDimensionPixelSize(R.styleable.FitMotionLayout_paddingEnd,0)
            ...
            val mPaddingHorizontal = ta.getDimensionPixelSize(R.styleable.FitMotionLayout_paddingHorizontal,0)
            if (mPaddingHorizontal > 0){
                mPaddingLeft = mPaddingHorizontal
                mPaddingRight = mPaddingHorizontal
            }
            val mPaddingVertical = ta.getDimensionPixelSize(R.styleable.FitMotionLayout_paddingVertical,0)
            if (mPaddingVertical > 0){
                mPaddingTop = mPaddingVertical
                mPaddingBottom = mPaddingVertical
            }
            val mPadding = ta.getDimensionPixelSize(R.styleable.FitMotionLayout_padding,0)
            if (mPadding > 0){
