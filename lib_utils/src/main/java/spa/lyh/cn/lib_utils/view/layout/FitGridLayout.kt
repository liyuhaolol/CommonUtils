...
open class FitGridLayout @JvmOverloads constructor(
    ...
    init {
        ...
        if(ta != null){
            fitLeft = ta.getBoolean(R.styleable.FitGridLayout_fitLeft, false)
            fitRight = ta.getBoolean(R.styleable.FitGridLayout_fitRight, false)
            fitTop = ta.getBoolean(R.styleable.FitGridLayout_fitTop, false)
            fitBottom = ta.getBoolean(R.styleable.FitGridLayout_fitBottom, false)
            mPaddingTop = ta.getDimensionPixelSize(R.styleable.FitGridLayout_paddingTop,0)
            mPaddingBottom = ta.getDimensionPixelSize(R.styleable.FitGridLayout_paddingBottom,0)
            mPaddingLeft = ta.getDimensionPixelSize(R.styleable.FitGridLayout_paddingLeft,0)
            mPaddingRight = ta.getDimensionPixelSize(R.styleable.FitGridLayout_paddingRight,0)
            val mPaddingStart = ta.getDimensionPixelSize(R.styleable.FitGridLayout_paddingStart,0)
            val mPaddingEnd = ta.getDimensionPixelSize(R.styleable.FitGridLayout_paddingEnd,0)
            ...
            val mPaddingHorizontal = ta.getDimensionPixelSize(R.styleable.FitGridLayout_paddingHorizontal,0)
            if (mPaddingHorizontal > 0){
                mPaddingLeft = mPaddingHorizontal
                mPaddingRight = mPaddingHorizontal
            }
            val mPaddingVertical = ta.getDimensionPixelSize(R.styleable.FitGridLayout_paddingVertical,0)
            if (mPaddingVertical > 0){
                mPaddingTop = mPaddingVertical
                mPaddingBottom = mPaddingVertical
            }
            val mPadding = ta.getDimensionPixelSize(R.styleable.FitGridLayout_padding,0)
            if (mPadding > 0){
