...
open class FitTableLayout @JvmOverloads constructor(
    ...
    init {
        ...
        if(ta != null){
            fitLeft = ta.getBoolean(R.styleable.FitTableLayout_fitLeft, false)
            fitRight = ta.getBoolean(R.styleable.FitTableLayout_fitRight, false)
            fitTop = ta.getBoolean(R.styleable.FitTableLayout_fitTop, false)
            fitBottom = ta.getBoolean(R.styleable.FitTableLayout_fitBottom, false)
            mPaddingTop = ta.getDimensionPixelSize(R.styleable.FitTableLayout_paddingTop,0)
            mPaddingBottom = ta.getDimensionPixelSize(R.styleable.FitTableLayout_paddingBottom,0)
            mPaddingLeft = ta.getDimensionPixelSize(R.styleable.FitTableLayout_paddingLeft,0)
            mPaddingRight = ta.getDimensionPixelSize(R.styleable.FitTableLayout_paddingRight,0)
            val mPaddingStart = ta.getDimensionPixelSize(R.styleable.FitTableLayout_paddingStart,0)
            val mPaddingEnd = ta.getDimensionPixelSize(R.styleable.FitTableLayout_paddingEnd,0)
            ...
            val mPaddingHorizontal = ta.getDimensionPixelSize(R.styleable.FitTableLayout_paddingHorizontal,0)
            if (mPaddingHorizontal > 0){
                mPaddingLeft = mPaddingHorizontal
                mPaddingRight = mPaddingHorizontal
            }
            val mPaddingVertical = ta.getDimensionPixelSize(R.styleable.FitTableLayout_paddingVertical,0)
            if (mPaddingVertical > 0){
                mPaddingTop = mPaddingVertical
                mPaddingBottom = mPaddingVertical
            }
            val mPadding = ta.getDimensionPixelSize(R.styleable.FitTableLayout_padding,0)
            if (mPadding > 0){
